...
KR_SOCCER: dict[str, str] = {
    ...
    '브라이튼': 'Brighton', '브라이턴&호브앨비언': 'Brighton', '크리스털팰리스': 'Crystal Palace',
    '크리스털 팰리스': 'Crystal Palace', '노팅엄포리스트': 'Nottingham Forest',
    '노팅엄 포리스트': 'Nottingham Forest', '본머스': 'Bournemouth', 'AFC본머스': 'Bournemouth',
    ...
    '파리FC': 'Paris FC',
    # ── Eredivisie (네덜란드) ─────────────────────────
    'AFC아약스': 'Ajax', '페예노르트': 'Feyenoord', 'PSV': 'PSV', 'PSV에인트호번': 'PSV',
    'AZ알크마르': 'AZ Alkmaar', 'PEC즈볼러': 'PEC Zwolle',
    '고어헤드이글스': 'Go Ahead Eagles', '스파르타로테르담': 'Sparta Rotterdam', '텔스타': 'Telstar',
    ...
    # ── Championship / EFL ───────────────────────────
    '리즈유나이티드': 'Leeds United', '미들즈브러': 'Middlesbrough', '블랙번로버스': 'Blackburn Rovers',
    ...
    '인천유나이티드': 'Incheon United', '강원FC': 'Gangwon FC',
    '광주FC': 'Gwangju FC', '대전하나시티즌': 'Daejeon Citizen',
    '제주SKFC': 'Jeju SK', '제주SK': 'Jeju SK', '제주 SK': 'Jeju SK',
    '김천상무프로축구단': 'Gimcheon Sangmu',
    '수원삼성블루윙즈': 'Suwon Bluewings',
    # ── K리그 2 / lower ──────────────────────────────
    '성남FC': 'Seongnam FC', '부산아이파크': 'Busan IPark',
    '경남FC': 'Gyeongnam', '서울이랜드': 'Seoul E-Land',
    '수원FC': 'Suwon FC', '부천FC1995': 'Bucheon FC 1995', '대구FC': 'Daegu FC',
    '안산그리너스': 'Ansan Greeners', '충남아산프로축구단': 'Chungnam Asan',
    '김포FC': 'Gimpo', '천안시티FC': 'Cheonan City',
    '충북청주프로축구단': 'Chungbuk Cheongju', '용인FC': 'Yongin',
    '화성FC': 'Hwaseong', '파주프런티어': 'Paju Citizen',
    '전남드래곤즈': 'Jeonnam Dragons', 'FC안양': 'Anyang',
    '김해FC2008': 'Gimhae',
    # ── MLS ──────────────────────────────────────────
    'LAFC': 'Los Angeles FC', 'LA갤럭시': 'Los Angeles Galaxy', '인터마이애미CF': 'Inter Miami',
    '애틀랜타유나이티드FC': 'Atlanta United', '뉴욕레드불스': 'New York Red Bulls',
    '뉴욕시티FC': 'New York City', '뉴잉글랜드레벌루션': 'New England Revolution',
    ...
    '세인트루이스시티SC': 'St Louis City SC', '오스틴FC': 'Austin FC',
    '시카고파이어FC': 'Chicago Fire', '샬럿FC': 'Charlotte FC',
    '샌디에이고FC': 'San Diego FC', '오클랜드FC': 'Auckland FC',
