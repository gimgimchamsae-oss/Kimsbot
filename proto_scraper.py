...
KR_SOCCER: dict[str, str] = {
    ...
    '하이덴하임': 'Heidenheim',
    # ── Serie A ──────────────────────────────────────
    '유벤투스': 'Juventus', '유벤투스FC': 'Juventus',
    'AC밀란': 'AC Milan', '밀란': 'AC Milan', 'AC 밀란': 'AC Milan',
    # Pinnacle은 "Roma" 사용 (AS 접두사 없음)
    'AS로마': 'Roma', '로마': 'Roma', 'AS 로마': 'Roma', '로마FC': 'Roma',
    'SSC나폴리': 'Napoli', '나폴리': 'Napoli', '나플리': 'Napoli',
    '인테르나치오날레밀라노': 'Inter Milan', '인테르나치오날레 밀라노': 'Inter Milan',
    '인테르밀란': 'Inter Milan', '인터밀란': 'Inter Milan',
    '인테르 밀란': 'Inter Milan', '인터 밀란': 'Inter Milan',
    '인테르나치오날레': 'Inter Milan', '인터나치오날레': 'Inter Milan',
    '볼로냐': 'Bologna', '아탈란타': 'Atalanta',
    '피오렌티나': 'Fiorentina', 'ACF피오렌티나': 'Fiorentina',
    '라치오': 'Lazio', '토리노': 'Torino',
    '제노아': 'Genoa', '제노바': 'Genoa',
    '파르마': 'Parma',
    '엘라스베로나': 'Hellas Verona', '베로나': 'Hellas Verona', '엘라스 베로나': 'Hellas Verona',
    'US레체': 'Lecce', '레체': 'Lecce',
    '코모1907': 'Como', '코모': 'Como',
    'US사수올로': 'Sassuolo', '사수올로': 'Sassuolo',
    'US크레모네세': 'Cremonese', '크레모네세': 'Cremonese',
    '피사SC': 'Pisa', '피사': 'Pisa',
    '엠폴리': 'Empoli',
    '우디네세': 'Udinese',
    '칼리아리': 'Cagliari',
    '베네치아': 'Venezia', '베네시아': 'Venezia', '베니스': 'Venezia',
    '몬차': 'Monza',
    '살레르니타나': 'Salernitana',
    '스페치아': 'Spezia',
    '프로시노네': 'Frosinone',
    ...
    '올랭피크드마르세유': 'Marseille', '마르세유': 'Marseille',
    '올랭피크리옹': 'Lyon', '리옹': 'Lyon',
    'AS모나코': 'Monaco', '모나코': 'Monaco',
    'OGC니스': 'Nice', '니스': 'Nice',
    '릴OSC': 'Lille', '릴': 'Lille',
    'RC랑스': 'Lens', '랑스': 'Lens',
    '스타드렌': 'Rennes', '렌': 'Rennes',
    '낭트': 'Nantes',
    'RC스트라스부르': 'Strasbourg', '스트라스부르': 'Strasbourg',
    '스타드브레스투아29': 'Brest', '브레스트': 'Brest',
    '툴루즈': 'Toulouse', 'AJ오세르': 'Auxerre', '오세르': 'Auxerre',
    '로리앙': 'Lorient',
    '앙제SCO': 'Angers', '앙제': 'Angers',
    '메스': 'Metz', '르아브르AC': 'Le Havre', '르아브르': 'Le Havre',
    '파리FC': 'Paris FC',
    # ── Eredivisie (네덜란드) ─────────────────────────
    'AFC아약스': 'Ajax', '아약스': 'Ajax',
    '페예노르트': 'Feyenoord', 'PSV': 'PSV',
